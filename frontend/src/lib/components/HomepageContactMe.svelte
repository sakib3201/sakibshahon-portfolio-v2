          ...
          >
            ...
            <div class="space-y-2">
              ...
              <input
                ...
                class="w-full bg-transparent text-inkonpaper text-lg py-2 rounded-none border border-t-0 border-l-0 border-r-0 border-b placeholder:text-inkonpaper/70 focus:border-b-goldbright focus:outline-none focus:ring-1 focus:ring-goldbright/50 {emailError !== '' ? 'border-b-goldbright' : 'border-b-inkonpaper/50'}"
              />
              {#if emailError !== ''}
            ...
            <div class="space-y-2">
              ...
              <textarea
                ...
                class="w-full bg-transparent text-inkonpaper text-lg py-2 px-0 resize-none rounded-none border border-t-0 border-l-0 border-r-0 border-b placeholder:text-inkonpaper/70 focus:border-b-goldbright focus:outline-none focus:ring-1 focus:ring-goldbright/50 {messageError !== '' ? 'border-b-goldbright' : 'border-b-inkonpaper/50'}"
              ></textarea>
              {#if messageError !== ''}
